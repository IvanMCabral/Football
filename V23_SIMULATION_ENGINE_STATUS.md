...
**Status:** V24D6M1-M7 COMPLETE. V24D6O COMPLETE. V24D6R COMPLETE — live match career mutation pipeline wired; v24-mutations profile available; smoke E2E passed. V24D6R2 COMPLETE — end-of-round lifecycle decrement wired in live path; newlyInjured/newlySuspended protection; participation-aware recovery. V24D6T COMPLETE — release blocker gaps closed; P1 #1 false positive confirmed; P1 #2 deferred with code docs; P1 #3 placeholder added. V24D6L release-readiness complete. See V24D6M phase table in Section 4 for full V24D6M status.
**Test status:** 832 total, 0 failures, 1 skipped; lifecycle/mutation/integration gate 284, 0 failures
**Test table:** V24EnergyRecoveryLifecycleApplierTest 18 | V24FormMutationApplierTest 18 | V24CareerMutationServiceTest 58 | V24CareerMutationIntegrationTest 60 | V24SuspensionLifecycleApplierTest 19 | V24InjuryMutationApplierTest 24 | V24InjuryRecoveryLifecycleApplierTest 22 | V24FatigueMutationApplierTest 30 | V24DisciplineMutationApplierTest 27 | V24MutationBalancingDiagnosticTest 7 | V24LivePathCareerMutationIntegrationTest 5 | V24SecondYellowDisciplineLifecycleIntegrationTest 2 | V24CareerMutationAvailabilityLifecycleIntegrationTest 3 | V24ManualSelectLineupAvailabilityBlockingTest 1 | V24LivePathEndOfRoundLifecycleDecrementTest 8 | V24ReleaseBlockerContractTest 5 | focused gate 284
**Date:** 2026-06-12
...
| `PlayerSeasonStatsQueryServiceTest` | 12 | V24D6M4/M7: query service, feature-gated, no-data returns empty, season filter, team/player filter, sort options, null-args validation, metadata/warnings |
| `PlayerSeasonStatsControllerTest` | 14 | V24D6M4/M7: controller endpoints, 200/400/404 responses, feature-disabled behavior, null/blank param validation, pagination validation |

**Total: 768 tests, 0 failures** (723 pre-M + 45 new in M3/M4/M7: 19 aggregator + 12 query service + 14 controller)
...
```
92669fb — feat: polish V24 player season stats API (V24D6M7)

...
/**
 * Use case for the smoke-test harness.
 *
 * <p>Provides deterministic state mutations used to run
 ...
 *       map (the detailed engine reads from the latter — regression
 *       fix).</li>
...
public interface TestHarnessUseCase {
    ...
    // Change the user team's tactical style.
    ...
    //
    // Optional physical and skill metadata:
    ...
    //
    // Backward-compatible: omitted fields are left unchanged.
    ...
    /**
     * Re-simulates a single match with a new
     ...
     *
     * <p>Used to run "what-if" experiments without creating
    ...
    /**
     * Resets every fixture of a round to a fresh, replayable state.
     */

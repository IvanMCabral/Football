...
public class User {
    ...
    private User(UserId id, String email, String username, String passwordHash, 
        ...
        this(id, email, username, passwordHash, role, createdAt, updatedAt, null);
    }

    private User(UserId id, String email, String username, String passwordHash,
                UserRole role, Instant createdAt, Instant updatedAt, UUID teamId) {
    ...
    public static User create(UserId id, String email, String username, String passwordHash) {
        return new User(id, email, username, passwordHash, UserRole.USER, Instant.now(), Instant.now(), null);
    }

    public static User createAdmin(UserId id, String email, String username, String passwordHash) {
        return new User(id, email, username, passwordHash, UserRole.ADMIN, Instant.now(), Instant.now(), null);
    }

    public static User reconstruct(UserId id, String email, String username, String passwordHash,
                                  UserRole role, Instant createdAt, Instant updatedAt, UUID teamId) {
        return new User(id, email, username, passwordHash, role, createdAt, updatedAt, teamId);
    }

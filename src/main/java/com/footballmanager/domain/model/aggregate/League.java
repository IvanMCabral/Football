...
/**
 * League - Entidad de PostgreSQL para ligas base.
 * El gameplay usa WorldLeague (en WorldSnapshot).
 */
public class League {
    ...
    private League(LeagueId id, String name, String country, Set<TeamId> teamIds,
                  Instant createdAt, Instant updatedAt, int seasonId, UUID winnerTeamId, LeagueStatus status) {
    ...
    public static League create(LeagueId id, String name, String country, int seasonId) {
        return new League(id, name, country, new HashSet<>(), Instant.now(), Instant.now(), seasonId, null, LeagueStatus.CREATED);
    }

    public static League reconstruct(LeagueId id, String name, String country, Set<TeamId> teamIds,
                                    Instant createdAt, Instant updatedAt, int seasonId, UUID winnerTeamId, LeagueStatus status) {
        return new League(id, name, country, teamIds, createdAt, updatedAt, seasonId, winnerTeamId, status);
    }

...
/**
 * Implementacion de StopMatchUseCase.
 * Detiene/cancela un partido en curso.
 *
 * NOTA: Implementacion intencionalmente similar a PauseMatchUseCaseImpl.
...
public class StopMatchUseCaseImpl implements StopMatchUseCase {

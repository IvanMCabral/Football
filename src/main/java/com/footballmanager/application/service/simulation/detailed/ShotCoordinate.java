 ...
 */
public final class ShotCoordinate {
    ...
    public ShotCoordinate(double x, double y, ShotLocation location) {
        this.x = validateX(x);
        this.y = validateY(y);
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ShotCoordinate that)) return false;
    ...
    public String toString() {
        return "ShotCoordinate{x=%.2f, y=%.2f, location=%s, dist=%.2f, angle=%.2f, insideBox=%s}"

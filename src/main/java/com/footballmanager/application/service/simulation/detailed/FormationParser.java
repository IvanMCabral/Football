 ...
 */
public final class FormationParser {

    private static final FormationShape BALANCED_DEFAULT = parseUnchecked("4-4-2");

    public FormationShape parse(String formation) {
     ...
     */
    private static FormationShape parseUncheckedOrDefault(String formation) {
        FormationShape f = parseUnchecked(formation);
     ...
     */
    private static FormationShape parseUnchecked(String formation) {
    ...
    private static FormationShape parseOneDash(String formation) {
        ...
        try {
            ...
            return new FormationShape(formation, first, midfielders, 0, 0, forwards);
    ...
    private static FormationShape parseTwoDashes(String formation) {
        String[] parts = formation.split("-");
        ...
        try {
            ...
            if ("4-3-3".equals(formation)) {
                ...
                return new FormationShape(formation, def, mid, 0, 2, totalForwards - 2);
            }
            ...
            if ("3-5-2".equals(formation)) {
                ...
                return new FormationShape(formation, def, mid, 0, 0, totalForwards);
            }
    ...
    private static FormationShape parseThreeDashes(String formation) {
        ...
        try {
            ...
            if ("4-2-3-1".equals(formation)) {
                ...
                return new FormationShape(formation, def, totalMid, 0, 0, fwd);
            }
            ...
            if ("4-1-2-3".equals(formation)) {
                return new FormationShape(formation, def, mid + am, 0, 2, 1);
            }
            // Generic 4-line formation: no separate wingers
            return new FormationShape(formation, def, mid, am, 0, fwd);
        } catch (NumberFormatException e) {
            return null;
        }
    }
     ...
     */
    public static final class FormationShape {
        ...
        public FormationShape(String raw, int defenders, int midfielders,
        ...
        public boolean equals(Object o) {
            ...
            if (!(o instanceof FormationShape that)) return false;
        ...
        public String toString() {
            return "FormationShape{raw='" + raw + "', def=" + defenders

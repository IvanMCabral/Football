...
/**
 * Lightweight player snapshot stored with detailed match detail so match-detail UI
 * can drive real DT actions (substitutions) without placeholder ids.
 */
public final class MatchLineupPlayerDto {
    ...
    public static MatchLineupPlayerDto fromSessionPlayer(SessionPlayer player) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MatchLineupPlayerDto that)) return false;

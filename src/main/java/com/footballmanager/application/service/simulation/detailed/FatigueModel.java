...
/**
 *  Pure function fatigue model for detailed match engine.
 *
 * <p>Provides:
 * <ul>
 ...
 * Deterministic from TeamStyle and PlayerMatchState.
 */
public final class FatigueModel {
     ...
     */
    public void applyDrain(PlayerMatchState player, int amount) {
        if (player == null) {
     ...
     */
    public double fatigueFactor(PlayerMatchState player) {
        if (player == null) {
            throw new IllegalArgumentException("player must not be null");
        }
     ...
     */
    public double applyFatigueToQuality(double quality, PlayerMatchState player) {
        if (player == null) {
            throw new IllegalArgumentException("player must not be null");
        }

...
/**
 * Immutable snapshot — not tied to internal ShotCoordinate.
 */
...
public final class ShotCoordinateDto {
    ...
    public static ShotCoordinateDto fromCoordinate(ShotCoordinate coordinate) {
        Objects.requireNonNull(coordinate, "coordinate must not be null");
        return new ShotCoordinateDto(
                coordinate.x(),
                coordinate.y(),
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ShotCoordinateDto that)) return false;
    ...
    public String toString() {
        return "ShotCoordinateDto{x=%.2f, y=%.2f, location=%s, dist=%.2f}"

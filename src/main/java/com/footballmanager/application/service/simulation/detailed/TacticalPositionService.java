...
final class TacticalPositionService {

    double tacticalYPercent(PlayerMatchState player, Map<String, LineupSlot> slotsByPlayerId) {
    ...
    double tacticalXPercent(PlayerMatchState player, Map<String, LineupSlot> slotsByPlayerId) {
        LineupSlot slot = slotFor(player, slotsByPlayerId);
    ...
    LineupSlot slotFor(PlayerMatchState player, Map<String, LineupSlot> slotsByPlayerId) {

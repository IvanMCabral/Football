...
/**
 * Immutable snapshot — not tied to PlayerMatchState.
 */
...
public final class PlayerMatchRatingDto {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PlayerMatchRatingDto that)) return false;
    ...
    public String toString() {
        return "PlayerMatchRatingDto{player='%s', team=%s, rating=%.2f, G=%d, A=%d}"

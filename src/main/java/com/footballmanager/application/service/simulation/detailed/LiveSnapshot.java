...
/**
 *
 * <p>Created by LiveSession.tick() and sent to the SSE stream
 ...
 * For final persistence, use LiveSession.finalResult() which carries
 */
public final class LiveSnapshot {
    ...
    private final List<DetailedMatchEvent> allEvents;
    ...
    public LiveSnapshot(
            ...
            String awayTeamId,
            boolean finished,
            List<DetailedMatchEvent> allEvents,
            int homePossession,
            int awayPossession) {
    ...
    public List<DetailedMatchEvent> allEvents() { return allEvents; }

...
public final class AssistModel {
    ...
    private final FormationParser formationParser = new FormationParser();
    ...
    public Optional<PlayerMatchState> selectAssistProvider(
            List<PlayerMatchState> candidates,
    ...
    private double assistWeight(PlayerMatchState p, String formation, TeamStyle style) {

 ...
 */
public final class PlayerRatingModel {
     ...
     */
    public double computePlayerRating(String playerId, MatchTimeline timeline) {
     ...
     */
    public Map<String, Double> computeRatings(Collection<String> playerIds, MatchTimeline timeline) {

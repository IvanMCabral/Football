 ...
 */
public final class CareerMutationPolicy {
    ...
    public String toString() {
        return "CareerMutationPolicy{mutateCareerState=%s, persistInjuries=%s, persistFatigue=%s, persistDiscipline=%s, persistForm=%s}"

...
final class MatchProbabilityService {
    ...
    double defensiveShapeShotQualityMultiplier(TacticalShapeProfile defense, ShotLocation location) {
    ...
    double defensiveStyleShotQualityMultiplier(TeamStyle defendingStyle, ShotLocation location) {

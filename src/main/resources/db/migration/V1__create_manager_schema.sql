...
CREATE TABLE players (
    ...
    identity_source_name VARCHAR(120),
    identity_source_ref TEXT,
    identity_checked_at DATE,
    position_source_ref TEXT,
    position_checked_at DATE,
    position_estimated BOOLEAN NOT NULL DEFAULT TRUE,
    country_id UUID NULL REFERENCES countries(id),
    name VARCHAR(160) NOT NULL,

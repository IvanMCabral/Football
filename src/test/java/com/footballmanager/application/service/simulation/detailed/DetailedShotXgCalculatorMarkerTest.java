 ...
 *   <li>MARKER gating:
 *     <ul>
 *       <li>Aplica SIEMPRE (en cualquier {@link ShotEventType}) porque
 ...
 * </ul>
 */
class ShotXgCalculatorMarkerTest {
    ...
    private static double xgWithMarker(ShotXgCalculator calc, int markerSkill,
    ...
    void marker90_xgEqualsBaselineTimes0_70() {
        ...
        double xg = xgWithMarker(calc, 90, ShotEventType.OPEN_PLAY);
    ...
    void marker50_xgEqualsBaselineTimes0_833() {
        ...
        double xg = xgWithMarker(calc, 50, ShotEventType.OPEN_PLAY);
    ...
    void marker99_xgEqualsBaselineTimes0_67() {
        ...
        double xg = xgWithMarker(calc, 99, ShotEventType.OPEN_PLAY);
    ...
    void marker0_xgEqualsBaseline() {
        ...
        double xg = xgWithMarker(calc, 0, ShotEventType.OPEN_PLAY);
    ...
    void marker90_onCorner_applies() {
        ...
        double xg = xgWithMarker(calc, 90, ShotEventType.CORNER);
    ...
    void marker90_onCross_applies() {
        ...
        double xg = xgWithMarker(calc, 90, ShotEventType.CROSS);
    ...
    void marker90_onAllEventTypes_applies() {
        ...
        // disponibles en ShotEventType.
        ShotXgCalculator calc = new ShotXgCalculator();
        for (ShotEventType eventType : ShotEventType.values()) {
            double baseline = calc.calculateXg(BASELINE_QUALITY, "4-3-3", "4-4-2",
                    70.0, 70.0,
                    Map.of(), null,
                    Map.of(), null,
    ...
    void onlyTacklerInDefenderSkills_doesNotApplyMarker() {
        ...
        // cubre en ShotXgCalculatorTacklerTest.
        ShotXgCalculator calc = new ShotXgCalculator();
        double baseline = calc.calculateXg(BASELINE_QUALITY, "4-3-3", "4-4-2",
                70.0, 70.0,
                Map.of(), null,
                Map.of(), null,
                ShotEventType.CORNER);  // CORNER: TACKLER gated off

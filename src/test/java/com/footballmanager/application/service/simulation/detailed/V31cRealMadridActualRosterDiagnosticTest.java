...
class V31cRealMadridActualRosterDiagnosticTest {
    ...
    private PerScenarioMetrics runScenario(DetailedMatchEngine engine,
        ...
        for (int seed = 1; seed <= n; seed++) {
            MatchContext ctx = buildContext(homeStart, homeName, awayStart, awayName, seed);
    ...
    private MatchContext buildContext(List<SessionPlayer> homeStart, String homeName,

 ...
 */
class SuspensionLifecycleApplierTest {

    private final SuspensionLifecycleApplier applier = new SuspensionLifecycleApplier();
    ...
    void nullCareer_returnsZero() {
        CareerMutationPolicy pol = policy(true);
    ...
    void participatedSuspendedPlayer_decrementedDetailedSprint6T2() {
        ...
        assertEquals(1, result, "suspended player in participatedPlayerIds still decrements");
        assertFalse(p.getSuspended());
        assertEquals(0, p.getSuspensionRemainingMatches());
    }

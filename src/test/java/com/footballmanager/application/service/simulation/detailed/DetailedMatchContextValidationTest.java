...
/**
 * DetailedA3: Validation tests for MatchContext.
 */
class MatchContextValidationTest {
    ...
    void rejectsInvalidStartingEleven() {
        ...
        MatchContext ctx = buildContext("match-valid", 75, 75);
    ...
    void acceptsShortHandedStartingEleven() {
        ...
        MatchContext shortCtx = new MatchContext(
                ctx.matchId(), ctx.homeTeamId(), ctx.awayTeamId(),
                ctx.homeTeam(), ctx.awayTeam(),
                homeStart, awayStart,
                List.of(), List.of(),

...
/**
 * {@link PlayerMatchState}. Per the F5 spec section 5:
 * <ul>
...
class PlayerMatchStateTest {
    ...
    void setPosition_nullOrBlank_throws() {
        PlayerMatchState player = makePlayer("p-1", "MID");
    ...
    private PlayerMatchState makePlayer(String id, String position) {

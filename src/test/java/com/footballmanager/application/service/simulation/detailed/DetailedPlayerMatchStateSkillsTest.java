 ...
 * al PlayerMatchState, y que el engine NO los usa todavia (no impact en
 */
class PlayerMatchStateSkillsTest {
    ...
    void fromSessionPlayer_copiesHeightAndSkills() {
        ...
        PlayerMatchState state = PlayerMatchState.fromSessionPlayer(player, "team-A");
    ...
    void fromSessionPlayer_nullHeightAndEmptySkills_yieldsNullAndEmpty() {
        ...
        PlayerMatchState state = PlayerMatchState.fromSessionPlayer(player, "team-B");

        assertNull(state.heightCm(),
                "heightCm null en SessionPlayer → null en PlayerMatchState");
        assertNotNull(state.skillLevels());
        assertTrue(state.skillLevels().isEmpty(),
                "skillLevels vacio en SessionPlayer → empty map en PlayerMatchState");
    }
    ...
    void fromSessionPlayer_sparseMapOnlyContainsNonZeroSkills() {
        ...
        PlayerMatchState state = PlayerMatchState.fromSessionPlayer(player, "team-C");
    ...
    void skillLevels_isReadOnly() {
        // PlayerMatchState.skillLevels() debe retornar unmodifiable view
        ...
        PlayerMatchState state = PlayerMatchState.fromSessionPlayer(player, "team-D");
    ...
    void fromSessionPlayer_defensiveCopyOnSkills() {
        ...
        PlayerMatchState state = PlayerMatchState.fromSessionPlayer(player, "team-E");

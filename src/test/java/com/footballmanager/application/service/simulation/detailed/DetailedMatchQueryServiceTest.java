...
class DetailedMatchQueryServiceTest {

    @Mock
    private DetailedMatchStoragePort storagePort;
    ...
    void setUp() {
        ...
        queryService = new DetailedMatchQueryService(storagePort, false);
    ...
    void findDetailReturnsEmptyWhenApiDisabled() {
        Optional<DetailedMatchData> result = queryService.findDetail("career-abc", "match-123").block();
    ...
    void findDetailReturnsDataWhenPresentAndApiEnabled() {
        queryService = new DetailedMatchQueryService(storagePort, true);
    ...
    void findDetailReturnsEmptyWhenMissingAndApiEnabled() {
        ...
        Optional<DetailedMatchData> result = queryService.findDetail("career-abc", "nonexistent").block();
    ...
    void careerIsolationSameMatchIdDifferentCareer() {
        ...
        Optional<DetailedMatchData> foundAbc = queryService.findDetail("career-abc", "match-123").block();
        Optional<DetailedMatchData> foundXyz = queryService.findDetail("career-xyz", "match-123").block();

...
class V24LeagueDetailPersistenceTest {
    ...
    void persistDetailTrueBuildsExpectedSnapshot() {
        ...
        DetailedMatchData detail = fakeStorage.savedDetail;
    ...
    // ========== Test 5: detailed match context build failure does not save detail ==========
    ...
    void contextBuildFailureDoesNotSaveDetail() {
        ...
        // Career with NO starting XI — MatchContextFactory.build() will throw
    ...
    void exposeDetailApiFlagDoesNotTriggerPersistence() {
        ...
        assertFalse(fakeStorage.saveCalled, "persistDetail=false should not save even with detailed match path");
        assertNotNull(career.getTournamentState().getFixtures().get(0).getResult());
    }

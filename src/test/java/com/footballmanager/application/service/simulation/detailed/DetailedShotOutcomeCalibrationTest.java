...
class DetailedShotOutcomeCalibrationTest {
    ...
    void onTargetProbability_isMonotonicWithXg() {
        double low = DetailedMatchEngine.onTargetProbability(0.02);
        double mid = DetailedMatchEngine.onTargetProbability(0.20);
        double high = DetailedMatchEngine.onTargetProbability(0.60);

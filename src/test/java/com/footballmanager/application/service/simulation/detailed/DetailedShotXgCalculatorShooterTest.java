 ...
 *
 * <ul>
 *   <li>SHOOTER multiplica el xG SOLO en {@link ShotLocation#LONG_RANGE}
 ...
 *   <li>SHOOTER gating:
 *     <ul>
 *       <li>Aplica SOLO en LONG_RANGE (location == ShotLocation.LONG_RANGE).</li>
 ...
 * </ul>
 */
class ShotXgCalculatorShooterTest {

    private static double baselineXgAt(ShotXgCalculator calc, ShotLocation loc) {
        ShotQuality q = new ShotQuality(loc, 0.7, 0.7, 0.3, 0.7, 1.0);
    ...
    private static double xgAt(ShotXgCalculator calc, ShotLocation loc, int shooterSkill) {
        ShotQuality q = new ShotQuality(loc, 0.7, 0.7, 0.3, 0.7, 1.0);
        return calc.calculateXg(q, "4-3-3", "4-4-2",
                70.0, 70.0,
    ...
    void shooter90_onLongRange_xgEqualsBaselineTimes1_36() {
        ...
        double baseline = baselineXgAt(calc, ShotLocation.LONG_RANGE);

        double xg = xgAt(calc, ShotLocation.LONG_RANGE, 90);
    ...
    void shooter99_onLongRange_xgEqualsBaselineTimes1_396() {
        ...
        double xg = xgAt(calc, ShotLocation.LONG_RANGE, 99);
    ...
    void shooter0_onLongRange_xgEqualsBaseline() {
        ...
        double xg = xgAt(calc, ShotLocation.LONG_RANGE, 0);
    ...
    void shooter90_onSixYardBox_doesNotApply() {
        ...
        ShotXgCalculator calc = new ShotXgCalculator();
        double baseline = baselineXgAt(calc, ShotLocation.SIX_YARD_BOX);

        double xg = xgAt(calc, ShotLocation.SIX_YARD_BOX, 90);
    ...
    void shooter90_onPenaltyAreaCenter_doesNotApply() {
        ShotXgCalculator calc = new ShotXgCalculator();
        double baseline = baselineXgAt(calc, ShotLocation.PENALTY_AREA_CENTER);

        double xg = xgAt(calc, ShotLocation.PENALTY_AREA_CENTER, 90);
    ...
    void shooter90_onPenaltyAreaWide_doesNotApply() {
        ShotXgCalculator calc = new ShotXgCalculator();
        double baseline = baselineXgAt(calc, ShotLocation.PENALTY_AREA_WIDE);

        double xg = xgAt(calc, ShotLocation.PENALTY_AREA_WIDE, 90);
    ...
    void shooter90_onOutsideBox_doesNotApply() {
        ...
        ShotXgCalculator calc = new ShotXgCalculator();
        double baseline = baselineXgAt(calc, ShotLocation.OUTSIDE_BOX);

        double xg = xgAt(calc, ShotLocation.OUTSIDE_BOX, 90);
    ...
    void absentShooterSkill_onLongRange_xgEqualsBaseline() {
        ...
        ShotQuality q = new ShotQuality(ShotLocation.LONG_RANGE, 0.7, 0.7, 0.3, 0.7, 1.0);
    ...
    void overload9ArgsWithShooter_outsideLongRange_preservesV25D32Baseline() {
        ...
        ShotQuality q = new ShotQuality(ShotLocation.PENALTY_AREA_CENTER, 0.7, 0.7, 0.3, 0.7, 1.0);

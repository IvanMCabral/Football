 ...
 */
class ShotCoordinateTest {

    private final ShotCoordinateGenerator generator = new ShotCoordinateGenerator();

    // ========== ShotCoordinate basic validity ==========
    ...
    void sixYardBoxCoordinateIsCloseToGoal() {
        var coord = generator.generate(ShotLocation.SIX_YARD_BOX, new Random(42));
    ...
    void longRangeCoordinateIsFartherThanPenaltyArea() {
        var longRange = generator.generate(ShotLocation.LONG_RANGE, new Random(1));
        var penaltyArea = generator.generate(ShotLocation.PENALTY_AREA_CENTER, new Random(1));
    ...
    void insideBoxFlagTrueWhenInPenaltyArea() {
        ...
        var coord = new ShotCoordinate(90.0, 50.0, ShotLocation.PENALTY_AREA_CENTER);
    ...
    void insideBoxFlagFalseWhenOutsideBox() {
        ...
        var coord = new ShotCoordinate(70.0, 50.0, ShotLocation.OUTSIDE_BOX);
        assertFalse(coord.insideBox(), "x=70, y=50 should be outside penalty area");
    }

    @Test
    void sameSeedProducesSameCoordinate() {
        var loc = ShotLocation.PENALTY_AREA_CENTER;
    ...
    void rejectsInvalidX() {
        assertThrows(IllegalArgumentException.class, () ->
                new ShotCoordinate(-0.1, 50.0, ShotLocation.PENALTY_AREA_CENTER));
        assertThrows(IllegalArgumentException.class, () ->
                new ShotCoordinate(100.1, 50.0, ShotLocation.PENALTY_AREA_CENTER));
        assertThrows(IllegalArgumentException.class, () ->
                new ShotCoordinate(Double.NaN, 50.0, ShotLocation.PENALTY_AREA_CENTER));
        assertThrows(IllegalArgumentException.class, () ->
                new ShotCoordinate(Double.POSITIVE_INFINITY, 50.0, ShotLocation.PENALTY_AREA_CENTER));
    }

    @Test
    void rejectsInvalidY() {
        assertThrows(IllegalArgumentException.class, () ->
                new ShotCoordinate(50.0, -0.1, ShotLocation.PENALTY_AREA_CENTER));
        assertThrows(IllegalArgumentException.class, () ->
                new ShotCoordinate(50.0, 100.1, ShotLocation.PENALTY_AREA_CENTER));
        assertThrows(IllegalArgumentException.class, () ->
                new ShotCoordinate(50.0, Double.NaN, ShotLocation.PENALTY_AREA_CENTER));
        assertThrows(IllegalArgumentException.class, () ->
                new ShotCoordinate(50.0, Double.POSITIVE_INFINITY, ShotLocation.PENALTY_AREA_CENTER));
    }
    ...
    void rejectsNullLocation() {
        ...
        assertThrows(NullPointerException.class, () ->
                new ShotCoordinate(50.0, 50.0, null));
    }
    ...
    void insideBoxBoundaryConditions() {
        ...
        var onBoundaryLeft = new ShotCoordinate(83.0, 21.0, ShotLocation.PENALTY_AREA_CENTER);
        var onBoundaryRight = new ShotCoordinate(83.0, 79.0, ShotLocation.PENALTY_AREA_CENTER);
        ...
        var justOutsideLeft = new ShotCoordinate(82.9, 50.0, ShotLocation.PENALTY_AREA_CENTER);
        var justOutsideLow = new ShotCoordinate(90.0, 20.9, ShotLocation.PENALTY_AREA_CENTER);
        var justOutsideHigh = new ShotCoordinate(90.0, 79.1, ShotLocation.PENALTY_AREA_CENTER);
    ...
    void distanceCalculationIsCorrect() {
        ...
        var atGoal = new ShotCoordinate(100.0, 50.0, ShotLocation.SIX_YARD_BOX);
        assertEquals(0.0, atGoal.distanceToGoal(), 0.001);

        // Shot at x=90, y=50 -> distance should be 10
        var tenMeters = new ShotCoordinate(90.0, 50.0, ShotLocation.SIX_YARD_BOX);
        assertEquals(10.0, tenMeters.distanceToGoal(), 0.001);

        // Shot at x=80, y=50 -> distance should be 20
        var twentyMeters = new ShotCoordinate(80.0, 50.0, ShotLocation.PENALTY_AREA_CENTER);
    ...
    void sixYardBoxRangeSupportsNarrowBand() {
        ...
        for (int seed = 1; seed <= 20; seed++) {
            var coord = generator.generate(ShotLocation.SIX_YARD_BOX, new Random(seed));

...
class V29bStyleEffectDiagnosticTest {
    ...
    private void runScenario(TeamStyle style, String label, int homeOvr, int awayOvr,
        ...
        for (int seed = 1; seed <= N_SIMULATIONS; seed++) {
            MatchContext ctx = buildContext(style, "v29b-" + style + "-" + label + "-" + seed,
    ...
    private double runAndAverage(DetailedMatchEngine engine, TeamStyle style,
        ...
        long totalGoals = 0;
        for (int seed = 1; seed <= N_SIMULATIONS; seed++) {
            MatchContext ctx = buildContext(style, "v29b-summary-" + style + "-" + homeOvr + "x" + awayOvr + "-" + seed,
    ...
    private MatchContext buildContext(TeamStyle style, String matchId,
                                         int homeOvr, int awayOvr,
                                         String homeFormation, String awayFormation) {

 ...
 */
class PlayerMatchStatsModelTest {

    private final PlayerMatchStatsModel model = new PlayerMatchStatsModel();
    ...
    void handlesEmptyTimeline() {
        ...
        for (PlayerMatchRatingDto dto : ratings) {
    ...
    void includesPlayersWithNoEventsAtBaseRating() {
        ...
        var timeline = new MatchTimeline();
        timeline.addEvent(event(10, DetailedMatchEventType.GOAL, "home", "p1", "P1", null, null, 0.3, "goal"));

        var ratings = model.computeRatings(players, timeline);

        assertEquals(3, ratings.size());
        Map<String, PlayerMatchRatingDto> map = byPlayerId(ratings);
    ...
    void countsGoalsFromGoalEvents() {
        var players = makePlayers("p1", "p2");
        var timeline = new MatchTimeline();
        timeline.addEvent(event(12, DetailedMatchEventType.GOAL, "home", "p1", "P1", null, null, 0.3, "g1"));
        timeline.addEvent(event(45, DetailedMatchEventType.GOAL, "home", "p1", "P1", null, null, 0.25, "g2"));
        timeline.addEvent(event(67, DetailedMatchEventType.GOAL, "home", "p2", "P2", null, null, 0.2, "g3"));
    ...
    void countsAssistsFromGoalRelatedPlayer() {
        ...
        timeline.addEvent(event(12, DetailedMatchEventType.GOAL, "home", "p1", "P1", "p2", "P2", 0.3, "g1"));
        // p2 scores unassisted
        timeline.addEvent(event(34, DetailedMatchEventType.GOAL, "home", "p2", "P2", null, null, 0.2, "g2"));
    ...
    void countsMultipleAssists() {
        ...
        var timeline = new MatchTimeline();
        timeline.addEvent(event(10, DetailedMatchEventType.GOAL, "home", "pX", "X", "pA", "A", 0.3, "g1"));
        timeline.addEvent(event(25, DetailedMatchEventType.GOAL, "home", "pY", "Y", "pA", "A", 0.25, "g2"));
        timeline.addEvent(event(40, DetailedMatchEventType.GOAL, "home", "pZ", "Z", "pA", "A", 0.2, "g3"));
    ...
    void countsShotsFromShotEvents() {
        var players = makePlayers("p1", "p2");
        var timeline = new MatchTimeline();
        timeline.addEvent(event(12, DetailedMatchEventType.SHOT, "home", "p1", "P1", null, null, 0.1, "s1"));
        timeline.addEvent(event(30, DetailedMatchEventType.SHOT, "home", "p1", "P1", null, null, 0.15, "s2"));
        timeline.addEvent(event(55, DetailedMatchEventType.SHOT, "home", "p2", "P2", null, null, 0.08, "s3"));
    ...
    void countsKeyPassesFromShotRelatedPlayer() {
        ...
        timeline.addEvent(event(12, DetailedMatchEventType.SHOT, "home", "p1", "P1", "p2", "P2", 0.12, "shot1"));
        // p2 shoots unassisted
        timeline.addEvent(event(45, DetailedMatchEventType.SHOT, "home", "p2", "P2", null, null, 0.1, "shot2"));
    ...
    void countsCardsInjuriesAndFouls() {
        var players = makePlayers("p1", "p2");
        var timeline = new MatchTimeline();
        timeline.addEvent(event(15, DetailedMatchEventType.YELLOW_CARD, "home", "p1", "P1", null, null, 0, "yc"));
        timeline.addEvent(event(30, DetailedMatchEventType.YELLOW_CARD, "home", "p1", "P1", null, null, 0, "yc2"));
        timeline.addEvent(event(50, DetailedMatchEventType.RED_CARD, "home", "p1", "P1", null, null, 0, "rc"));
        timeline.addEvent(event(40, DetailedMatchEventType.INJURY, "home", "p2", "P2", null, null, 0, "inj"));
        timeline.addEvent(event(20, DetailedMatchEventType.FOUL, "home", "p2", "P2", null, null, 0, "foul"));
    ...
    void marksSubstitutedOutAndIn() {
        ...
        timeline.addEvent(event(60, DetailedMatchEventType.SUBSTITUTION, "home", "pOff", "Off", "pOn", "On", 0, "sub"));
    ...
    @Test
    void ratingMatchesPlayerRatingModel() {
        var players = makePlayers("p1");
        var timeline = new MatchTimeline();
        timeline.addEvent(event(12, DetailedMatchEventType.GOAL, "home", "p1", "P1", null, null, 0.3, "goal"));
        timeline.addEvent(event(45, DetailedMatchEventType.YELLOW_CARD, "home", "p1", "P1", null, null, 0, "yc"));
    ...
    void unrelatedEventsDoNotAffectPlayer() {
        ...
        var timeline = new MatchTimeline();
        // only p2 events
        timeline.addEvent(event(12, DetailedMatchEventType.GOAL, "home", "p2", "P2", null, null, 0.3, "goal"));
        timeline.addEvent(event(33, DetailedMatchEventType.YELLOW_CARD, "home", "p2", "P2", null, null, 0, "yc"));
    ...
    void deterministicForSameTimeline() {
        var players = makePlayers("p1", "p2");
        var timeline = new MatchTimeline();
        timeline.addEvent(event(12, DetailedMatchEventType.GOAL, "home", "p1", "P1", "p2", "P2", 0.35, "goal"));
    ...
    private List<PlayerMatchState> makePlayers(String... ids) {
    ...
    private PlayerMatchState makePlayer(String playerId, String teamId) {
        ...
        return PlayerMatchState.fromSessionPlayer(sp, teamId);
    }
    ...
    private Map<String, PlayerMatchRatingDto> byPlayerId(List<PlayerMatchRatingDto> list) {
        return list.stream().collect(Collectors.toMap(PlayerMatchRatingDto::playerId, Function.identity()));
    }
}
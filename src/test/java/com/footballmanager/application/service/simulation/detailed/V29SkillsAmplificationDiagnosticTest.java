...
class V29SkillsAmplificationDiagnosticTest {
     ...
     */
    private void runScenarioWithSkills(DetailedMatchEngine engine, String title,
        ...
        for (int seed = 1; seed <= N_SIMULATIONS; seed++) {
            MatchContext ctx = buildContextWithSkills(
     ...
     */
    private double runAndAverage(DetailedMatchEngine engine,
                                 int homeOvr, int awayOvr,
                                 String homeFormation, String awayFormation) {
        long totalGoals = 0;
        for (int seed = 1; seed <= N_SIMULATIONS; seed++) {
    ...
    private MatchContext buildContextWithSkills(String matchId, int homeOvr, int awayOvr,
                                                   String homeFormation, String awayFormation) {

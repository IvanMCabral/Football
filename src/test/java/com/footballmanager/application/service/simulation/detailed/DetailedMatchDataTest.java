...
class DetailedMatchDataTest {
    ...
    void timelineIsDefensivelyCopied() {
        var original = new java.util.ArrayList<DetailedMatchEventDto>();
        var dto1 = new DetailedMatchEventDto(10, "GOAL", "home", "p1", "P1", null, null, 0.3, "", null);
        original.add(dto1);
        ...
        assertThrows(UnsupportedOperationException.class, () ->
                detail.timeline().add(new DetailedMatchEventDto(30, "GOAL", "home", "p3", "P3", null, null, 0.2, "", null)));
    }

    @Test
    void playerRatingsAreDefensivelyCopied() {
        var original = new java.util.ArrayList<PlayerMatchRatingDto>();
        var dto1 = new PlayerMatchRatingDto("p1", "P1", "t", "MID", 6.5, 0, 0, 0, 0, 0, 0, 0, 0, false, false);
        original.add(dto1);
        ...
        // Stored list is unmodifiable
        assertThrows(UnsupportedOperationException.class, () ->
                detail.playerRatings().add(new PlayerMatchRatingDto("p3", "P3", "t", "ATT", 6.2, 0, 0, 0, 0, 0, 0, 0, 0, false, false)));
    }

    @Test
    void fromResultRejectsBlankMatchId() {
        var result = DetailedMatchResult.builder()
                .matchId("  ")
        ...
        assertThrows(IllegalArgumentException.class, () ->
                DetailedMatchData.fromResult("career", 1, 1, "H", "A", result, List.of()));
    }
    ...
    void fromResultRejectsBlankCareerId() {
        var result = DetailedMatchResult.builder()
                ...
                .build();
        assertThrows(IllegalArgumentException.class, () ->
                DetailedMatchData.fromResult("  ", 1, 1, "H", "A", result, List.of()));
    }
    ...
    void fromResultMapsAggregateFields() {
        ...
        var detail = DetailedMatchData.fromResult(
    ...
    void fromResultMapsTimelineEventsWithNullShotCoordinate() {
        ...
        timeline.addEvent(new DetailedMatchEvent(12, DetailedMatchEventType.GOAL, "home", "p1", "Player One", "p2", "Assist", 0.35, "goal"));
        timeline.addEvent(new DetailedMatchEvent(33, DetailedMatchEventType.YELLOW_CARD, "home", "p3", "Player Three", null, null, 0, "foul"));
        ...
        var detail = DetailedMatchData.fromResult("career-1", null, null, "TeamA", "TeamB", result, List.of());

        assertEquals(2, detail.timeline().size());

        DetailedMatchEventDto goal = detail.timeline().get(0);
    ...
    void equalsAndHashCode_includeFormation() {
        ...
        var baseWithNull = DetailedMatchData.fromResult(
                "career-EQ", 1, 1, "H", "A", null, null, result, List.of());
        var baseWith433 = DetailedMatchData.fromResult(
                "career-EQ", 1, 1, "H", "A", "4-3-3", "4-4-2", result, List.of());
        var sameAs433 = DetailedMatchData.fromResult(
                "career-EQ", 1, 1, "H", "A", "4-3-3", "4-4-2", result, List.of());
        var differentFormation = DetailedMatchData.fromResult(
    ...
    void jacksonDeserialization_handlesNullFormation() throws Exception {
        ...
        DetailedMatchData detail = mapper.readValue(jsonOld, DetailedMatchData.class);
    ...
    void jacksonRoundtrip_preservesFormation() throws Exception {
        ...
        DetailedMatchData deserialized = mapper.readValue(json, DetailedMatchData.class);

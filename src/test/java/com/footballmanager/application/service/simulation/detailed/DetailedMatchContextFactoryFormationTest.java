...
/**
 * {@link MatchContextFactory#build} prefers the persisted formation
 ...
 * the detailed match engine ran every match with the default team formation
 * (typically 4-3-3), ignoring the formation the manager selected via
 * {@code /lineup/manual-select}.
 */
class MatchContextFactoryFormationTest {

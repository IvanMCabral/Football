 ...
 * </ul>
 */
class DetailedMatchEngineSpeedsterTest {
    ...
    void fullMatch_speedsterHigh_producesMoreShotsThanBaselineInCounter() {
        ...
        MatchContext baseline = buildContextWithSpeedster("speedster-base", TeamStyle.COUNTER, -1);
        MatchContext treatment = buildContextWithSpeedster("speedster-high", TeamStyle.COUNTER, 99);
    ...
    void fullMatch_speedsterHigh_inAttacking_doesNotProduceMoreShotsThanBaseline() {
        ...
        MatchContext baseline = buildContextWithSpeedster("speedster-base-att", TeamStyle.ATTACKING, -1);
        MatchContext treatment = buildContextWithSpeedster("speedster-high-att", TeamStyle.ATTACKING, 99);
    ...
    void fullMatch_noSpeedsterSkill_preservesV25D33Baseline() {
        ...
        MatchContext baseline = buildContextWithSpeedster("no-speedster", TeamStyle.COUNTER, -1);
    ...
    private double invokeChanceProb5(TeamStyle style, int minute, int attack,
        ...
        return new MatchProbabilityService()
    ...
    private MatchContext buildContextWithSpeedster(String matchId, TeamStyle homeStyle, int speedsterSkill) {

...
class PlayerSeasonStatsAggregatorTest {
    ...
    void detailsWithOnlyNullEntries_returnsEmptyResponse() {
        List<DetailedMatchData> details = new ArrayList<>();
        details.add(null);
        details.add(null);
    ...
    void filtersByCareerAndSeason() {
        DetailedMatchData match1 = makeDetail("career1", 1, "match1", "teamA",
                List.of(makeRating("p1", "teamA", 7.0, 0, 0, 0, 0, 0, 0, 0, 0, false, false)));
        DetailedMatchData match2 = makeDetail("career2", 1, "match2", "teamA",
                List.of(makeRating("p1", "teamA", 7.0, 0, 0, 0, 0, 0, 0, 0, 0, false, false)));
    ...
    void duplicateMatchId_notDoubleCounted() {
        DetailedMatchData match = makeDetail("career1", 1, "match1", "teamA",
    ...
    void goalsAndAssistsAggregatedCorrectly() {
        ...
        DetailedMatchData m1 = makeDetail("career1", 1, "match1", "teamA",
                List.of(makeRating("p1", "teamA", 7.5, 2, 1, 5, 0, 0, 0, 0, 0, false, false)));
        DetailedMatchData m2 = makeDetail("career1", 2, "match2", "teamA",
    ...
    void averageBestWorstRatingComputedCorrectly() {
        ...
        DetailedMatchData m3 = makeDetail("career1", 3, "match3", "teamA",
    ...
    void teamIsolation_samePlayerDifferentTeamsCreatesSeparateRows() {
        ...
        DetailedMatchData m2 = makeDetail("career1", 2, "match2", "teamB",
    ...
    void playerFilter_returnsOnlyRequestedPlayer() {
        DetailedMatchData match = makeDetail("career1", 1, "match1", "teamA", List.of(
    ...
    void lastUpdatedRoundUsesMaxRound() {
        DetailedMatchData m5 = makeDetail("career1", 5, "match5", "teamA",
                List.of(makeRating("p1", "teamA", 7.0, 0, 0, 0, 0, 0, 0, 0, 0, false, false)));
        DetailedMatchData m10 = makeDetail("career1", 10, "match10", "teamA",
                List.of(makeRating("p1", "teamA", 7.0, 0, 0, 0, 0, 0, 0, 0, 0, false, false)));
        DetailedMatchData m3 = makeDetail("career1", 3, "match3", "teamA",
                List.of(makeRating("p1", "teamA", 7.0, 0, 0, 0, 0, 0, 0, 0, 0, false, false)));
    ...
    void nullPlayerRatingsInDetail_handledSafely() {
        DetailedMatchData match = makeDetailWithNullRatings("career1", 1, "match1", "teamA");
    ...
    void nullRatingEntryInList_handledSafely() {
        List<PlayerMatchRatingDto> ratings = new ArrayList<>();
        ratings.add(null);
        ratings.add(makeRating("p1", "teamA", 7.0, 1, 0, 0, 0, 0, 0, 0, 0, false, false));
        ratings.add(null);

        DetailedMatchData match = makeDetailWithCustomRatings("career1", 1, "match1", "teamA", ratings);
    ...
    void responseTotalsComputedCorrectly() {
        // m1: p1 (2G, 1A), p2 (0G)
        // m2: p1 (1G, 2A), p2 (0G)
        DetailedMatchData m1 = makeDetail("career1", 1, "match1", "teamA", List.of(
                makeRating("p1", "teamA", 7.0, 2, 1, 0, 0, 0, 0, 0, 0, false, false),
                makeRating("p2", "teamA", 6.5, 0, 0, 0, 0, 0, 0, 0, 0, false, false)
        ));
        DetailedMatchData m2 = makeDetail("career1", 2, "match2", "teamA", List.of(
     ...
     */
    private PlayerMatchRatingDto makeRating(
    ...
    private DetailedMatchData makeDetail(
        ...
        return new DetailedMatchData(
                ...
                "summary", "DETAILED_MATCH", 1, java.time.Instant.now(), null, null);
    }

    private DetailedMatchData makeDetailWithNullRatings(
            String careerId, int round, String matchId, String homeTeamId) {
        return new DetailedMatchData(
                matchId, careerId, 1, round,
                homeTeamId, "awayTeam",
    ...
    private DetailedMatchData makeDetailWithCustomRatings(
            String careerId, int round, String matchId, String homeTeamId,
            List<PlayerMatchRatingDto> playerRatings) {
        return new DetailedMatchData(
                matchId, careerId, 1, round,

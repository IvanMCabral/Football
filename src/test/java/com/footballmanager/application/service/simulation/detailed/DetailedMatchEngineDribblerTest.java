 ...
 * </ol>
 */
class DetailedMatchEngineDribblerTest {
    ...
    void fullMatch_dribblerHigh_producesMoreShotsThanBaseline() {
        ...
        MatchContext baseline = buildContextWithDribbler("dribbler-base", 0);
        MatchContext treatment = buildContextWithDribbler("dribbler-high", 99);
    ...
    void fullMatch_noDribblerSkill_preservesV25D32Baseline() {
        ...
        MatchContext baseline = buildContextWithDribbler("no-dribbler", -1);  // sentinel: sin DRIBBLER
    ...
    /**
     * Construye un MatchContext con 11 jugadores por equipo, todos con el
     ...
     */
    private MatchContext buildContextWithDribbler(String matchId, int dribblerSkill) {

...
/**
 *
 * <p>Validates that MatchContext, MatchContextFactory, and
 * TeamMatchState accept lineups in {@code [MIN_AVAILABLE_PLAYERS, 11]}
 * and reject lineups outside that range.
 */
class MatchContextShortHandedTest {
    ...
    // ========== T4: MatchContextFactory uses short-handed starting11 ==========
    ...
    void v24TeamMatchState_acceptsShortHandedStarting() {
        ...
        TeamMatchState state = TeamMatchState.create(
    ...
    void v24TeamMatchState_rejects6Starting() {
        ...
        List<SessionPlayer> homeBench = makePlayers("home-bench", 5, 75);
        assertThrows(IllegalArgumentException.class, () ->
                TeamMatchState.create(homeTeam, homeStart, homeBench, TeamStyle.BALANCED));
    }
    ...
    private MatchContext makeContext(int homeSize, int awaySize) {

...
class InjuryModelTest {
    ...
    private final InjuryModel model = new InjuryModel();
    ...
    void minClampIs0_0005_V25D81_1() {
        ...
        PlayerMatchState p = makePlayer("min-clamp", 70, 100);
    ...
    void maxClampAllowsUpTo0_05_V25D81_1() {
        ...
        PlayerMatchState exhausted = makePlayer("max-clamp", 70, 5);
    ...
    void lowStaminaIncreasesInjuryRisk() {
        PlayerMatchState fresh = makePlayer("fresh-injury", 70, 90);
        PlayerMatchState tired = makePlayer("tired-injury", 70, 25);
    ...
    void veryLowStaminaIncreasesMoreThanLowStamina() {
        PlayerMatchState exhausted = makePlayer("exhausted-injury", 70, 10);
        PlayerMatchState low = makePlayer("low-injury", 70, 30);
        PlayerMatchState fresh = makePlayer("fresh-injury", 70, 90);
    ...
    void highIntensityActionIncreasesInjuryRisk() {
        PlayerMatchState player = makePlayer("hi-action", 70, 70);
    ...
    void attackingAndCounterSlightlyIncreaseRisk() {
        PlayerMatchState player = makePlayer("style-injury", 70, 70);
    ...
    void injuryProbabilityIsClamped() {
        PlayerMatchState player = makePlayer("clamp-injury", 70, 100);
        ...
        PlayerMatchState maxPlayer = makePlayer("max-injury", 70, 15);
        ...
        PlayerMatchState exhausted = makePlayer("ex-injury", 70, 5);
    ...
    void shouldInjureIsDeterministicWithSeed() {
        PlayerMatchState player = makePlayer("determ-injury", 70, 40);
    ...
    void injuredPlayerIsOffPitch() {
        PlayerMatchState player = makePlayer("off-pitch-injury", 70, 70);
    ...
    void nullRandomThrowsOnShouldInjure() {
        PlayerMatchState p = makePlayer("norandom-inj", "MID", 70, 70);
        assertThrows(IllegalArgumentException.class,
    ...
    void nullStyleDefaultsToBalanced() {
        PlayerMatchState player = makePlayer("null-style", 70, 70);
    ...
    private PlayerMatchState makePlayer(String id, int ovr, int stamina) {

 ...
 * </ol>
 */
class DetailedMatchEngineRandomOverloadTest {
    ...
    void sameRandom_sameSeed_sameResult() {
        ...
        DetailedMatchResult a = engine.simulate(ctx, r1);
        DetailedMatchResult b = engine.simulate(ctx, r2);
    ...
    void cachingRandomWrapper_determinism() {
        ...
        DetailedMatchResult a = engine.simulate(ctx, new CachingRandomWrapper(seed));
        DetailedMatchResult b = engine.simulate(ctx, new CachingRandomWrapper(seed));
    ...
    void cachingWrapper_cacheIsPopulated() {
        ...
        DetailedMatchResult result = engine.simulate(ctx, wrapper);
    ...
    void sameWrapper_afterReset_deterministic() {
        ...
        DetailedMatchResult a = engine.simulate(ctx, wrapper);
        ...
        DetailedMatchResult b = engine.simulate(ctx, wrapper);

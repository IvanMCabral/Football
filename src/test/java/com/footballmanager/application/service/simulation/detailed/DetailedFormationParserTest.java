 ...
 */
class FormationParserTest {

    private final FormationParser parser = new FormationParser();
    ...
    void nullPlayersThrowsOnSelectShooter() {
        PlayerSelector selector = new PlayerSelector(new java.util.Random(42));
    ...
    void formationAffectsSelectionDeterministically() {
        ...
        PlayerSelector sel1 = new PlayerSelector(new java.util.Random(99));
        var result1 = sel1.selectShooter(players, "4-4-2");
        PlayerSelector sel2 = new PlayerSelector(new java.util.Random(99));
    ...
    void sameSeedDifferentFormationGivesDifferentOrSamePlayer() {
        ...
        PlayerSelector sel433 = new PlayerSelector(new java.util.Random(42));
        var shooter433 = sel433.selectShooter(players433, "4-3-3");

        PlayerSelector sel442 = new PlayerSelector(new java.util.Random(42));

...
class PlayerSeasonStatsQueryServiceTest {
    ...
    void getPlayerSeasonStats_noData_returnsEmptyResponse() {
        ...
        assertThat(response.message()).contains("No detailed match detail data found");
    }

    @Test
    void getPlayerSeasonStats_withData_delegatesToAggregator() {
        DetailedMatchData match1 = makeDetail(CAREER_ID, 1, "match-1", "team-A", List.of(
    ...
    void getPlayerSeasonStats_filtersBySeason() {
        DetailedMatchData matchS1 = makeDetail(CAREER_ID, 1, "match-1", "team-A", List.of(
                makeRating("p1", "team-A", 7.0, 1, 0, 3, 0, 0, 0, 0, 1, false, false)
        ));
        DetailedMatchData matchS2 = makeDetail(CAREER_ID, 2, "match-2", "team-A", List.of(
    ...
    void getPlayerSeasonStats_withRealMadridScenario_teamFilterReturnsNonEmpty() {
        ...
        DetailedMatchData match1 = makeDetail(careerId, 1, "match-146f10bd", "373705ee-42fd-4ddf-b0a8-67a529e1eb57", List.of(
        ...
        DetailedMatchData match2 = makeDetail(careerId, 1, "match-other", "some-other-team", List.of(

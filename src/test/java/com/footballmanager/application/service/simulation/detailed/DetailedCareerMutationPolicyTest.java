...
/**
 * P1b: Unit tests for CareerMutationPolicy.
 ...
 */
class CareerMutationPolicyTest {
    ...
    void rawGetters_reflectFlagValues() {
        CareerMutationPolicy p = policy(true, true, false, true, false);
    ...
    void allFlagsTrue_allDerivedGettersTrue() {
        CareerMutationPolicy p = policy(true, true, true, true, true);
        assertTrue(p.isInjuryPersistenceEnabled());
    ...
    void allFlagsFalse_allDerivedGettersFalse() {
        CareerMutationPolicy p = policy(false, false, false, false, false);

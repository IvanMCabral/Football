 ...
 */
class PlayerRatingModelTest {

    private final PlayerRatingModel model = new PlayerRatingModel();
    ...
    void noEventsGivesBaseRating() {
        var timeline = new MatchTimeline();
        timeline.addEvent(event(1, DetailedMatchEventType.SHOT, "team", "other", "other", null, null, 0.10, "shot"));
        assertEquals(6.0, model.computePlayerRating("p1", timeline), 0.001);
    }
    ...
    void goalIncreasesRatingBy08() {
        var timeline = new MatchTimeline();
        timeline.addEvent(event(12, DetailedMatchEventType.GOAL, "team", "p1", "Player One", null, null, 0.35, "goal"));
    ...
    void twoGoalsIncreaseRatingBy16() {
        var timeline = new MatchTimeline();
        timeline.addEvent(event(12, DetailedMatchEventType.GOAL, "team", "p1", "Player One", null, null, 0.35, "goal"));
        timeline.addEvent(event(45, DetailedMatchEventType.GOAL, "team", "p1", "Player One", null, null, 0.20, "goal"));
    ...
    void assistIncreasesRatingBy05() {
        ...
        timeline.addEvent(event(12, DetailedMatchEventType.GOAL, "team", "p1", "Scorer", "p2", "AssistProvider", 0.35, "goal"));
    ...
    void multipleAssistsStack() {
        var timeline = new MatchTimeline();
        timeline.addEvent(event(12, DetailedMatchEventType.GOAL, "team", "pX", "X", "p1", "Player One", 0.30, "g1"));
        timeline.addEvent(event(34, DetailedMatchEventType.GOAL, "team", "pY", "Y", "p1", "Player One", 0.25, "g2"));
        timeline.addEvent(event(78, DetailedMatchEventType.GOAL, "team", "pZ", "Z", "p1", "Player One", 0.20, "g3"));
    ...
    void shotAddsSmallBonus() {
        var timeline = new MatchTimeline();
        timeline.addEvent(event(12, DetailedMatchEventType.SHOT, "team", "p1", "Player One", null, null, 0.10, "shot"));
    ...
    void highXgShotAddsExtraBonus() {
        var timeline = new MatchTimeline();
        timeline.addEvent(event(12, DetailedMatchEventType.SHOT, "team", "p1", "Player One", null, null, 0.40, "shot"));
    ...
    void shotAtExactly030ThresholdGetsBonus() {
        var timeline = new MatchTimeline();
        timeline.addEvent(event(12, DetailedMatchEventType.SHOT, "team", "p1", "Player One", null, null, 0.30, "shot"));
        assertEquals(6.15, model.computePlayerRating("p1", timeline), 0.001);
    }
    ...
    void shotBelow030ThresholdOnlyGetsBaseShotBonus() {
        var timeline = new MatchTimeline();
        timeline.addEvent(event(12, DetailedMatchEventType.SHOT, "team", "p1", "Player One", null, null, 0.29, "shot"));
        assertEquals(6.10, model.computePlayerRating("p1", timeline), 0.001);
    }
    ...
    void keyPassIncreasesRatingBy03() {
        ...
        timeline.addEvent(event(12, DetailedMatchEventType.SHOT, "team", "p1", "Shooter", "p2", "KeyPasser", 0.12, "shot"));
    ...
    void yellowCardDecreasesBy03Each() {
        var timeline = new MatchTimeline();
        timeline.addEvent(event(12, DetailedMatchEventType.YELLOW_CARD, "team", "p1", "Player One", null, null, 0, "foul"));
    ...
    void twoYellowCardsDecreaseBy06() {
        var timeline = new MatchTimeline();
        timeline.addEvent(event(12, DetailedMatchEventType.YELLOW_CARD, "team", "p1", "Player One", null, null, 0, "yc1"));
        timeline.addEvent(event(67, DetailedMatchEventType.YELLOW_CARD, "team", "p1", "Player One", null, null, 0, "yc2"));
    ...
    void redCardDecreasesBy15() {
        var timeline = new MatchTimeline();
        timeline.addEvent(event(78, DetailedMatchEventType.RED_CARD, "team", "p1", "Player One", null, null, 0, "red"));
    ...
    void injuryPenaltyApplied() {
        var timeline = new MatchTimeline();
        timeline.addEvent(event(55, DetailedMatchEventType.INJURY, "team", "p1", "Player One", null, null, 0, "injury"));
    ...
    void foulPenaltySmall() {
        var timeline = new MatchTimeline();
        timeline.addEvent(event(33, DetailedMatchEventType.FOUL, "team", "p1", "Player One", null, null, 0, "foul"));
    ...
    void ratingClampedToTen() {
        ...
        for (int i = 0; i < 6; i++) {
            int min = 10 + i * 10;
            timeline.addEvent(event(min, DetailedMatchEventType.GOAL, "team", "p1", "P1", "pA" + i, "PA", 0.3, "g"));
        }
    ...
    void ratingClampedToOne() {
        ...
        for (int i = 0; i < 4; i++) {
            timeline.addEvent(event(10 + i * 20, DetailedMatchEventType.RED_CARD, "team", "p1", "P1", null, null, 0, "r"));
        }
        for (int i = 0; i < 10; i++) {
            timeline.addEvent(event(15 + i * 8, DetailedMatchEventType.FOUL, "team", "p1", "P1", null, null, 0, "f"));
        }
    ...
    void sameTimelineProducesSameRating() {
        var timeline = new MatchTimeline();
        timeline.addEvent(event(12, DetailedMatchEventType.GOAL, "team", "p1", "P1", null, null, 0.35, "goal"));
        timeline.addEvent(event(45, DetailedMatchEventType.YELLOW_CARD, "team", "p1", "P1", null, null, 0, "yc"));
    ...
    void unrelatedEventsDoNotAffectPlayer() {
        var timeline = new MatchTimeline();
        timeline.addEvent(event(12, DetailedMatchEventType.GOAL, "team", "other", "Other", null, null, 0.35, "goal"));
        timeline.addEvent(event(33, DetailedMatchEventType.YELLOW_CARD, "team", "another", "Another", null, null, 0, "yc"));
        timeline.addEvent(event(55, DetailedMatchEventType.SHOT, "team", "third", "Third", null, null, 0.10, "shot"));
        // p1 has no events
        assertEquals(6.0, model.computePlayerRating("p1", timeline), 0.001);
    }
    ...
    void substitutionIncomingGets05() {
        ...
        timeline.addEvent(event(60, DetailedMatchEventType.SUBSTITUTION, "team", "pOff", "Off", "pOn", "On", 0, "sub"));
    ...
    void chanceCreatedDoesNotAffectRating() {
        var timeline = new MatchTimeline();
        timeline.addEvent(event(12, DetailedMatchEventType.CHANCE_CREATED, "team", "p1", "P1", null, null, 0, "chance"));
        assertEquals(6.0, model.computePlayerRating("p1", timeline), 0.001);
    }
    ...
    void saveDoesNotAffectRating() {
        var timeline = new MatchTimeline();
        timeline.addEvent(event(12, DetailedMatchEventType.SAVE, "team", "p1", "P1", null, null, 0, "save"));
        assertEquals(6.0, model.computePlayerRating("p1", timeline), 0.001);
    }
    ...
    void missDoesNotAffectRating() {
        var timeline = new MatchTimeline();
        timeline.addEvent(event(12, DetailedMatchEventType.MISS, "team", "p1", "P1", null, null, 0, "miss"));
        assertEquals(6.0, model.computePlayerRating("p1", timeline), 0.001);
    }
    ...
    void multipleEventsOnSameMinuteAllCounted() {
        ...
        timeline.addEvent(event(45, DetailedMatchEventType.SHOT, "team", "p1", "P1", null, null, 0.10, "s1"));
        timeline.addEvent(event(45, DetailedMatchEventType.FOUL, "team", "p1", "P1", null, null, 0, "f1"));
    ...
    private DetailedMatchEvent event(int minute, DetailedMatchEventType type, String teamId,
                                 String playerId, String playerName,
                                 String relatedPlayerId, String relatedPlayerName,
                                 double xg, String desc) {
        return new DetailedMatchEvent(minute, type, teamId, playerId, playerName,

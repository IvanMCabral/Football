 ...
 * </ol>
 */
class LiveSessionScoreStabilityTest {
    ...
    void tick_sameMinute_sameSnapshot() {
        ...
        LiveSnapshot snap1 = session.tick();
    ...
    void tick_firstTick_scoreStable() {
        ...
        LiveSnapshot firstTickA = runA.tick();
        ...
        DetailedMatchResult finalA = runA.finalResult();
        ...
        DetailedMatchResult finalB = runB.finalResult();
    ...
    void tick_doesNotReRunEngine() {
        ...
        DetailedMatchResult finalResult = session.finalResult();
    ...
    void tick_mutationThenStable() {
        ...
        LiveSnapshot beforeMutation = session.tick();
        ...
        LiveSnapshot afterMutation = session.tick();

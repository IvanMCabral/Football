...
class MatchContextFactoryTest {

    private final MatchContextFactory factory = new MatchContextFactory();
    ...
    void buildsContextFromValidCareerFixture() {
        ...
        MatchContext ctx = factory.build(career, fixture, homeTeam, awayTeam, 42L);
    ...
    void defaultsStylesToBalanced() {
        ...
        MatchContext ctx = factory.build(career, fixture, homeTeam, awayTeam, 0L);
    ...
    void usesProvidedStylesWhenOverloadProvided() {
        ...
        MatchContext ctx = factory.buildWithStyles(
    ...
    void carriesPersistedCustomSlotCoordinatesIntoMatchContextByPlayerId() {
        ...
        MatchContext ctx = factory.build(career, fixture, homeTeam, awayTeam, 99L);

        LineupSlot movedSlot = ctx.homeSlotsByPlayerId().get(movedPlayerId);
        assertNotNull(movedSlot,
                "The detailed match context must expose persisted modal slots keyed by playerId, "
    ...
    void deterministicSameInputProducesSameContext() {
        ...
        MatchContext ctx1 = factory.build(career, fixture, homeTeam, awayTeam, seed);
        MatchContext ctx2 = factory.build(career, fixture, homeTeam, awayTeam, seed);

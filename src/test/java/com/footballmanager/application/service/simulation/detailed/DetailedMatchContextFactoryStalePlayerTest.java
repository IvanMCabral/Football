 ...
 *
 * <p>The F5.2 fix in MatchContextFactory: if teamStarting11 has stale
 ...
 */
class MatchContextFactoryStalePlayerTest {
    ...
    void stalePlayer_triggersFullFallback() {
        ...
        MatchContext ctx = factory.build(career, fixture, home, away, 42L);
        assertNotNull(ctx);

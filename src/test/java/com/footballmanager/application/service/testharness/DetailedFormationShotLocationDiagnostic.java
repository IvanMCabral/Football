 ...
 *
 * <p>Run with: {@code mvn test -Dtest=DetailedFormationShotLocationDiagnostic}.
 *
    ...
    void diagnosticPrintPerSeedMetrics() {
        ...
        for (long seed : seeds) {
            for (String f : formations) {
                DetailedMatchData d = replayWithFormation(f, seed);
        ...
        for (long seed : seeds) {
            DetailedMatchData d433 = replayWithFormation("4-3-3", seed);
            DetailedMatchData d442 = replayWithFormation("4-4-2", seed);
            DetailedMatchData d352 = replayWithFormation("3-5-2", seed);
            DetailedMatchData d4231 = replayWithFormation("4-2-3-1", seed);

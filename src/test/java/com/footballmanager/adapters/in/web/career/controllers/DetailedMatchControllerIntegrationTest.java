...
class DetailedMatchControllerIntegrationTest {
    ...
    private static DetailedMatchData sampleDetail() {
    ...
    void getDetail_found_returns200() {
        DetailedMatchData detail = sampleDetail();
        ...
        assertInstanceOf(DetailedMatchData.class, response.getBody());
    }
    ...
    void getTimeline_minute45_returns200WithSnapshot() {
        ...
        assertNotNull(response);
        assertEquals(HttpStatus.OK, response.getStatusCode());
        assertInstanceOf(TimelineSnapshot.class, response.getBody());

        TimelineSnapshot snap = (TimelineSnapshot) response.getBody();
    ...
    void getTimeline_minute0_returns200WithEmptySnapshot() {
        ...
        DetailedMatchData d = new DetailedMatchData(
                MATCH_ID, CAREER_ID, 1, 5,
                HOME, AWAY,
                "Home FC", "Away FC",
                2, 1, 1.8, 0.9,

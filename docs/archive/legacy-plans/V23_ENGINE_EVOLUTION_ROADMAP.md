...
**V24D6T docs/status update:** COMPLETED — commit `90c91f9`
**Tests:** 832 full suite total; 832 regression gate, 0 failures, 1 skipped
**Date:** 2026-06-12
...
```
Expected: 768 tests (regression gate), 0 failures; 768 full suite total (723 pre-M + 45 in M3/M4/M7).
---
...
| **V24D6R** | **Live Match Career Mutation Pipeline — Complete** | | | **Completed** |
| V24D6R1 | V24LivePathCareerMutationIntegrationTest (5 tests) — Completed (`b9220c4`) | — | Done | Completed |
| V24D6R2 | V24CareerMutationAvailabilityLifecycleIntegrationTest (3 tests) — Completed (`b9220c4`) | — | Done | Completed |
| V24D6R3 | V24ManualSelectLineupAvailabilityBlockingTest (1 test) — Completed (`b9220c4`) | — | Done | Completed |
